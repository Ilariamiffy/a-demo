...
//查所有
Mock.mock('http://localhost:8080/mock/supplier/getAll', 'get', () => {
    return list;
})

//查一个
Mock.mock(RegExp('http://localhost:8080/mock/supplier/getId' + '*'), 'get', (option) => {
...
//增加
Mock.mock('http://localhost:8080/mock/supplier/add', 'post', (option) => {
...
//删除
Mock.mock(RegExp('http://localhost:8080/mock/supplier/delete' + '*'), 'delete', (option) => {
...
//修改
Mock.mock(RegExp('http://localhost:8080/mock/supplier/update' + '*'), 'post', (option) => {
